...
export default function initSelectFilter() {
  let count = 0;
  return function closureSelectFilter(selectWrap) {
    count++;
    ...
    selects.forEach((element) => {
      ...
      selectStyled.setAttribute('data-toogle-id', count);
      ...
      ulStyled.setAttribute('data-toogle-id', count);
